...
uint8_t PN532::mifareclassic_WriteNDEFURI (uint8_t sectorNumber, uint8_t uriIdentifier, const char *url)
{
    ...
    // in NDEF records
    uint8_t temp1 = len+(uint8_t)5;
    uint8_t temp2 = len+(uint8_t)1;
    // Setup the sector buffer (w/pre-formatted TLV wrapper and NDEF message)
    uint8_t sectorbuffer1[16] = {0x00, 0x00, 0x03, temp1, 0xD1, 0x01, temp2, 0x55, uriIdentifier, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
